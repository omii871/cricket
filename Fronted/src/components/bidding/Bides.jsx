...
const Bides = () => {
 ...
 useEffect(() => {
  ...
  return (
    <>
      <div className='flex justify-between h-130 bg-gray-100 p-0'>
        {/* players */}
        <div className='bg-gray-200 w-full p-2 '>
                ...
                onClick={async () => {
                  ...
                  if (filteredPlayersRef.current.length > 0) {
                    ...
                    try {
                      ...
                      const upcoming = filteredPlayersRef.current[1]; // index 1 = next
                      if (upcoming) {
          ...
          {/* Players */}
          <div className='h-120  overflow-y-auto  p-1 rounded-2xl shadow-md  transition-transform duration-1000 ease-in-out hover:scale-102'>
              ...
              <ul className="space-y-2">
                {filteredPlayers
                  ...
                  .map((player) => (
                    ...
                    <li key={player._id} className="p-2 border-2 border-amber-100 rounded-lg bg-white shadow-lg flex items-center gap-4">
                      <img
                        src={player.fileUrl}
                        alt={player.name}
                        className="w-26 h-26 rounded-full object-center border-5  border-blue-100 "
                      />
                      <div>
                ...
                {biddingPlayers.map((player) => (
                  ...
                  >
                    <div className="flex flex-col items-center gap-4">
                      ...
                      />
                      <div className="grid grid-cols-2 gap-x-4 text-gray-800 w-full">
        ...
        <div className="bg-gray-200 w-full rounded-lg p-4 h-130">
          <h3 className="text-center font-serif font-bold text-2xl mb-3">Sold & Unsold Players</h3>

          {/* 📦 Sold Players */}
          <div className="bg-green-50 rounded-md p-2 shadow overflow-y-auto h-30 mb-4">
            <h3 className="text-xl font-bold mb-2 text-green-800 text-center">📦 Sold Players</h3>
            <ul className="space-y-2">
              {soldPlayers.length > 0 ? (
                soldPlayers.map((player) => (
                  <li key={player.playerId} className="p-2 border rounded-md bg-green-100 text-sm">
          ...
          {/* 🚫 Unsold Players */}
          <div className="bg-red-50 rounded-md p-2 shadow overflow-y-auto mb-4 h-30">
            <h3 className="text-xl font-bold mb-2 text-red-800 text-center">🚫 Unsold Players</h3>
            <ul className="space-y-2">
              {unsoldPlayers.length > 0 ? (
                unsoldPlayers.map((player) => (
                  <li key={player.playerId} className="p-2 border rounded-md bg-red-100 text-sm">
          ...
          {/* 🔜 Upcoming Player */}
          <div className="bg-yellow-50 rounded-md p-2 shadow overflow-y-auto">
            <h3 className="text-xl font-bold mb-2 text-yellow-700 text-center">🔜 Upcoming Player</h3>
            {(() => {
              ...
              return upcomingPlayer ? (
                <div className="p-3 border rounded-md bg-yellow-100 shadow-md">
      ...
      <div className="p-4 font-bold" >
        <h2 className="text-center text-2xl font-semibold mb-4">Owner</h2>
        {
          ownerData.length > 0 ? (
            <ul className="grid grid-cols-4 gap-2">
              {ownerData.map((owner, index) => (
                <li
                  key={index}
                  className="p-3 shadow-lg rounded-full flex items-center gap-x-2 bg-blue-100  transition-transform duration-1000 ease-in-out hover:scale-103"
                >
                  <img
                    src={owner.fileUrl}
                    alt={owner.name}
                    className="w-22 h-24 rounded-full object-cover border-4 border-amber-400 shadow-lg"
                  />
                  <div className="flex flex-col ">
                    ...
                    <div className="flex items-center">
                      <input
                        type="text"
                        placeholder="₹0.00"
                        className="w-20 px-4 py-1 border border-gray-300 rounded-s-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      ...
                      <button
                        ...
                        className="w-10 py-1 bg-blue-500 text-white rounded-e-lg hover:bg-blue-700 transition">
                        Send
                      </button>
                    </div>
                  </div>
